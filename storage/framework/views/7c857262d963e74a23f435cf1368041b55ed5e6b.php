<?php $__env->startSection('contenido'); ?>
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<?php echo Form::model($persona,['method'=>'PATCH','route'=>['cliente.update',$persona->idpersona]]); ?>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
					<div class"form-group">
						...
						<input type="text" name="direccion"  value="<?php echo e($persona->direccion); ?>" class="form-control" placeholder="Dirección del cliente">
					</div>	
				...
				<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
					<div class"form-group">
						...
						<input type="text" name="telefono"  value="<?php echo e($persona->telefono); ?>" class="form-control" placeholder="Telefono del cliente...">
					</div>	
